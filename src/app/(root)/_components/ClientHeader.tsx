    ...
    return (
        <nav className={cn(
            ...
            <div className="flex items-center gap-2">
                <div className="flex items-center gap-2">
                    <Dialog>
                        <DialogTrigger asChild>
                            <button
                                className="hidden lg:flex p-2 bg-muted hover:bg-muted/80 rounded-full cursor-pointer items-center justify-center"
                            >
                ...
                <ThemeProvider>
                    <button className="p-2 bg-muted hover:bg-muted/80 rounded-full">
                        <LuSun size={16} />
                    </button>
                </ThemeProvider>
                ...
                <Link
                    ...
                    className="flex items-center gap-1.5 bg-card hover:bg-sidebar-accent rounded-full h-9 px-3.5 py-2 cursor-pointer transition-all duration-200 hover:scale-102 active:scale-98"
                >
