    ...
    return (
        <nav
            ...
            <div className="hidden md:flex items-center text-foreground">
                ...
                <p className="relative ml-1 -top-1 font-semibold text-sm font-sans">
                    IDE
                </p>
            </div>

            {/* Middle section - Stopwatch & Code Controls */}
                ...
                <div className="flex items-center gap-2">
                    <Dialog>
                        <DialogTrigger asChild>
                            <button className="flex p-2 hover:bg-muted/80 rounded-full cursor-pointer items-center justify-center">
